...
import Projeto_Escola.Projeto_Escola.apllication.dto.ProfessorDto;
import Projeto_Escola.Projeto_Escola.entity.Coordenador;
import Projeto_Escola.Projeto_Escola.entity.Professor;
import Projeto_Escola.Projeto_Escola.entity.repository.CoordenadorRepository;
...
public class CoordenadorService {
    ...
    private List<Professor> mapEquipe(List<ProfessorDto> professorDtos) {
        return professorDtos.stream().map(professorDto -> {
            ...
            professor.setUnidadesCurriculares(professor.getUnidadesCurriculares());
            return professor;
        }).toList();
