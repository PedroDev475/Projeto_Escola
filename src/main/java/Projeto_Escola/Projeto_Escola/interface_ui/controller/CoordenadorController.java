...
import Projeto_Escola.Projeto_Escola.apllication.dto.CoordenadorDto;
import Projeto_Escola.Projeto_Escola.apllication.services.CoordenadorService;
...
public class CoordenadorController {
    ...
    @PostMapping
    public ResponseEntity<String> salva (@RequestBody CoordenadorDto coordenadorDto){
    ...
    public ResponseEntity<CoordenadorDto> buscarPorId(@PathVariable Long id ){
     ...
     public  ResponseEntity<String> atualizar(@PathVariable Long id, @RequestBody CoordenadorDto coordenadorDto){
         if(coordenadorService.atualizar(id,coordenadorDto)) {
             return ResponseEntity.ok("Coordenador atualizado com sucessp!");
         }else{
    ...
    public ResponseEntity<String> deletar(@PathVariable Long id ){
        if(coordenadorService.deletar(id)) {
            return ResponseEntity.ok("Coordenador deletadp com sucesso");
        }else{
            return ResponseEntity.notFound().build();
        }
    }
